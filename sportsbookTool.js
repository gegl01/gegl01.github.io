(function() {
    ...
    window.initStreamMappingHelper = () => {
        ...
        replaceBodyEventListenersWith(new BodyEventListener("click", listenerForStreamMappingHelper));
