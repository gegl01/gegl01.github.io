(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initSetEventPhaseSection() {
            ...
            let categoryIdsForNoScoreBoard = ["7", "26", "43", "53", "116"];
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        return {
            ...
            varState: 0,
            phaseCategoryId: isFirstHalf ? "1-1" : "2-1"
        };
    }
    ...
    function getAmericanFootballScoreBoard() {
        ...
        let scoreBoard = {
            ...
            currentPhase: {
                id: 3,
                label: getPhaseLabelifNotEnglish("3rd Quarter")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
