        ...
        function addSelectionToPopularPreBuiltBets(eventId, selectionId) {
            ...
            if (i >= 0) {
                ...
                if (ev.selectionIds.length < 3) {
                    log("ev.selectionIds.length " + ev.selectionIds.length);
                    hide(popularBetsTooManySelectionsMessage);
