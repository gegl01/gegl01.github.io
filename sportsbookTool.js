(function () {
    ...
    function getParticipantLabelByParticiapantId(participantId) {
    ...
    let isSeparatePenaltiesEnabled = getConfig()?.sportsbook?.scoreboard?.separatePenalties;
    ...
    function initSbToolsEvent(scope) {
        ...
        // const popularityForEventDetails = getElementById("popularityForEventDetails");
        ...
        startPolling(listenerForProviders);
        ...
        function listenerForEvent() {
            ...
            if (eventId === null) {
                ...
                // popularityForEventDetails.innerText = getEventPopularityOrder(eventId);
        ...
        //     if (getIsTagPresent("sb-traded-prematch") && getIsTagPresent("sb-traded-live")) return "Prematch & Live";
        //     if (getIsTagPresent("sb-traded-prematch")) return "Prematch only";
        //     if (getIsTagPresent("sb-traded-live")) return "Live only";
        //     else return "Undefined (missing 'sb-traded' tags)";
        // }
        ...
        window.submitRtScoreBoardUpdate = () => {
            ...
            const homePenaltyScore = Number(fdRtPenaltyScoreHome.value);
            const awayPenaltyScore = Number(fdRtPenaltyScoreAway.value);
            ...
            const scorePerParticipant = {
                [homeParticipantId]: (categoryId == "1") && isSeparatePenaltiesEnabled ? getRandomInt(500, 599) : homeScore,
        ...
        window.createMarket = () => {
            ...
            function getMarketTabsOnEventPanel() {
                const root = IS_MFE ? shadowRoot : document;
            ...
            function createPlayerPropsMarket() {
                ...
                const playerPropsMarketName = "Player Props by SB Tool";
                ...
                function createMarketForPlayer(player, lineValue) {
                    ...
                    createSelection(false, lineValue);
                }
        ...
        //             option.text = getParticipantLabelByParticiapantId(participant.id);
        //         } else {
        ...
        function populateParticipantSelector() {
            ...
            const options = participants.map(participant => {
                ...
                option.text = participant.label === ""
                    ? getParticipantLabelByParticiapantId(participant.id)
                    : participant.label;
                option.value = participant.id;
                return option;
            });
        ...
        //     getState().sportsbook.event.events[eventId].hasFastMarkets = chkHasFastMarkets.checked;
        // }
    ...
    function initWalletFunctions() {
        ...
        if (!(IS_OBGSTATE_OR_XSBSTATE_EXPOSED && (IS_B2B_IFRAME_ONLY || IS_MFE))) {
            return;
        }
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        const homeFinalScore = getRandomInt(7);
        const awayFinalScore = isPenaltyShootout ? homeFinalScore : getRandomInt(7);
        ...
        return {
            participants,
            scorePerParticipant: {
                [participants[0].id]: isSeparatePenaltiesEnabled ? getRandomInt(500, 599) : homeFinalScore,
                [participants[1].id]: isSeparatePenaltiesEnabled ? getRandomInt(500, 599) : awayFinalScore
            },
            statistics: {
                [participants[0].id]: {
                    corners: {
                    ...
                    goalsScored: {
                        value: isSeparatePenaltiesEnabled ? 666 : homeFinalScore,
                        isActive: false
                    },
                    goalsScoredExceptPenaltyPhase: {
                        value: isSeparatePenaltiesEnabled ? homeFinalScore : getRandomInt(700, 799),
                        isActive: true
                    },
                    ...
                    aggregateScore: {
                        value: homeFinalScore + getRandomInt(4), isActive: scoreBoardExtras.isAggActive
                    },
                    stoppageTime: {
                ...
                [participants[1].id]: {
                    ...
                    goalsScored:
                    {
                        value: isSeparatePenaltiesEnabled ? 666 : awayFinalScore,
                        isActive: false
                    },
                    goalsScoredExceptPenaltyPhase: {
                        value: isSeparatePenaltiesEnabled ? awayFinalScore : getRandomInt(700, 799),
                        isActive: true
                    },
                    goalsScoredOnPenaltyPhase: {
                        value: isPenaltyShootout ? getRandomInt(3) : 0,
                    ...
                    aggregateScore:
                    {
                        value: awayFinalScore + getRandomInt(4),
                        isActive: scoreBoardExtras.isAggActive
                    },
                    stoppageTime:
                    {
