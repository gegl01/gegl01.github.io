(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initCreatePlayerPropsMarketSection() {
            ...
            hide(createFastMarketSection, createPreBuiltMarketSection, createPlayerSpecialsSection);
        ...
        function initCreatePlayerSpecialsMarketSection() {
            ...
            hide(createFastMarketSection, createPreBuiltMarketSection, createPlayerPropsSection);
        ...
        function initCreateFastMarketSection() {
            ...
            hide(createPlayerPropsSection, createPreBuiltMarketSection, createPlayerSpecialsSection);
    ...
    function getRandomFootballJerseyUrl() {
        const isNewJerseySupported = isSbVersionAtLeast(7, 32);
