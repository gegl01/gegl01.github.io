        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    // redCards: { value: 0, isActive: true },
        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    oneEighties: { value: getRandomInt(homeFinalScore), isActive: true },
                ...
                [participants[1].id]: {
                    ...
                    isServer: { value: !isServer, isActive: true },
                    oneEighties: { value: getRandomInt(awayFinalScore), isActive: true },
                    matchFormat: { value: "0", isActive: true },
                    matchFormatSummary: { value: "0", isActive: true }
