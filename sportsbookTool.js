(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function createPriceBoostObject(eventId, marketId, selectionId, categoryId, competitionId, isSuperBoost) {
            ...
            let maximumStake = isSuperBoost ? 1200 : 120;
            let maxOdds = isSuperBoost ? 5000 : 50;

            let priceBoostStateItem = {
                "id": sbToolPriceBoostId,
                "name": namePrefix + " generated by SB Tool, can't lookup in TT",
                "type": "PriceBoost",
