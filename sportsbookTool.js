(function () {
    ...
    //     let competitionName = obgState.sportsbook.event.events[eventId].competitionName;
    ...
    //     //         "competitionId": "5319",
    //     //         "competitionPopularity": 0,
    //     //         "fixturePopularity": {}
    //     //     },
    //     //     "correlationId": "06c2784a-be4e-4b31-a69b-31fbf0ea3dda"
    //     // })
    ...
    //         let events = obgState.sportsbook.event.events;
    //         let participantLabelArray = [];
    //         for (ev in events) {
    //             participantLabelArray.push(events[ev].participants[0].label);
    //             participantLabelArray.push(events[ev].participants[1].label);
    //         }
    //         let randomParticipantLabels = [];
    //         for (let i = 0; i < amount; i++) {
    //             let randomLabel = getRandomElementFromArray(participantLabelArray);
