(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initSetEventPhaseSection() {
            categoryId = getCategoryIdByEventId(eventId);
            let eligibleCategoryIdsForScoreBoard = ["1", "2", "3", "4", "9", "11", "19", "34", "58", "60", "72", "104", "119", "138"];
    ...
    function getFootballScoreBoard(participants) {
        ...
        return {
            ...
            matchClock: {
                ...
                minutes: isFirstHalf ? getRandomInt(45) : getRandomInt(90),
    ...
    function getHandballScoreBoard() {
        let isFirstHalf = getRandomBoolean();
        ...
        let scoreBoard = {
            ...
            matchClock: {
                seconds: getRandomInt(59),
                minutes: isFirstHalf ? getRandomInt(1, 29) : getRandomInt(30, 59),
                gameClockMode: "Stopped",
                lastDateTimeSet: lastDateTimeSet
            },
            varState: 0
