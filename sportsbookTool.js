(function () {
    ...
    function initSbToolsMarket(scope) {
        ...
        //     const THREE_COLUMN_DATA_MISSING = "Could not get data for 3-column layout.\nPlease remove the detected market from the betslip, then add again.";
        //     const MARKET_NOT_PART_OF_THREE_COLUMN = "Only 3-column cards allowed here, while the selected market cannot be part of that.\nDisplaying the default 3-column markets of the event.";

        //     var carouselOrCardsDefined = isCarouselOrCardsDefined();
        ...
        //             }
        //             return;
        //         } else if (!isMarketTemplateIdPartOfThreeColumn(marketTemplateId)) {
    ...
    function isMarketTemplateIdPartOfThreeColumn(marketTemplateId) {
