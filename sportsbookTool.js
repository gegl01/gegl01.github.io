(function () {
    ...
    // var savedEventId;
    // end of hack
    https://www.qa.betsafe.com/en/promotions/sportsbook-leaderboards
        ...
        function listenerForSelection() {
            ...
            if (isHomePage != previousIsHomePage) {
                ...
                if (isHomePage) {
                    ...
                    hide(popularBetsNotHomeMessage, betsOfTheDayNotHomeMessage);
                } else {
                    hide(popularBetsControls, betsOfTheDayControls);
                    show(popularBetsNotHomeMessage, betsOfTheDayNotHomeMessage);
                }
            }
    ...
    function initSbToolsEvent(scope) {
        ...
        window.setParticipantLogo = (logoType) => {
            ...
            if (logoType == "flag") {
                getState().sportsbook.sportCatalog.offering
                    .categories[getCategoryIdByEventId(eventId)]
                    .regions[getCompetitionIdByEventId(eventId)]
                    .competitions[getCompetitionIdByEventId(eventId)]
                    .tagsshouldShowFlag = true;
            }
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        const homeFinalScore = getRandomInt(4);
        const awayFinalScore = getRandomInt(4);
