    ...
    function initSbToolsMarket(scope) {
        ...
        function listenerForMarket() {
            ...
            function checkIfPageIsValidToAddToCarousel() {
                isPageValidForCarousel = (isPageCardCapable() || isPageHomePage());
        ...
        window.addToCarousel = () => {
            ...
            // var categoryInUsFormat = isCategoryInUsFormat(getCategoryIdByEventId(eventId));
            // if (isCategoryInUsFormat(categoryId) && !isEventTypeOutright(eventId) && isMarketTemplateIdPartOfThreeColumn(marketTemplateId)) {
