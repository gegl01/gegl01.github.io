(function () {
    ...
    function updatePriceBoost(priceBoostObj) {
        log("\nupdatePriceBoost called" + "\npriceBoost Id: " + priceBoostObj.id);
    ...
    function updateCategoryAndCompetitionForPbLobby(categoryId, competitionId) {
        log("\nupdateCategoryAndCompetitionForPbLobby called" + "\ncategoryId: " + categoryId + "\ncompetitionId: " + competitionId);
