(function () {
    ...
    function initWalletFunctions() {
        ...
        if (IS_SEALSTORE_ENABLED) show(sealStoreWalletMessage);
        ...
        Object.entries(wallet.wallets).forEach(([currencyCode, data]) => {
            ...
            if (IS_SEALSTORE_ENABLED) inactivate(button, input);
        });
