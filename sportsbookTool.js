(function () {
    ...
    function initSbToolsSelection(scope) {
        ...
        const radioPbSingle = document.getElementById("radioPbSingle");
        ...
        window.createPbFromSelections = () => {
            ...
            let priceBoostObj = {
                ...
                criteria: {
                    eventPhases: isCombi ? ["Prematch"] : createPbEventPhases,
                    marketTemplateIds: [],
        ...
        function addSelectionToPriceBoost(isCombi) {
            ...
            for (let selId of selectionIdArray) {
                eventId = getEventIdBySelectionId(selId);
                eventIdArray.push(eventId);
                marketId = getMarketIdBySelectionId(selId);
                categoryId = getCategoryIdByEventId(eventId);
                ...
                let criteriaEntityDetail = {
                    ...
                    eventId: eventId,
                    marketId: marketId,
                    marketSelectionId: selId
                }
                pbCriteriaEntityDetailsArray.push(criteriaEntityDetail);
                setPbEventMap(eventId, isCombi ? ["Prematch"] :  ["Prematch", "Live"]);
                setPbMarketMap(marketId, isCombi ? ["Prematch"] :  ["Prematch", "Live"]);
            }
        }
    ...
    function initSbToolsEvent(scope) {
        ...
        function createPriceBoostForEvent(isSuperBoost) {
            ...
            updatePriceBoost(priceBoostObj);
            setPbEventMap(eventId, ["Prematch", "Live"]);
            setPbMarketMap(marketId, ["Prematch", "Live"]);
        }
