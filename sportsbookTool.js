(function () {
    ...
    var participants = [];
    var previousEventId, previousMarketId, previousSelectionId;
    ...
    function initSbToolsEvent(scope) {
        ...
        function listenerForEvent() {
            ...
            // isEventFootball = getCategoryIdByEventId(eventId) == "1";
        ...
        window.submitRtScoreBoardUpdate = () => {
            ...
            const scorePerParticipant = {
                [homeParticipantId]: (categoryId == "1") && separatePenalties ? 666 : homeScore,
                [awayParticipantId]: (categoryId == "1") && separatePenalties ? 666 : awayScore
            };
    ...
    function hide(...elements) {
        // Flatten any nested arrays (including NodeLists or HTMLCollections)
        elements.flat().forEach(el => el?.classList?.add("hide"));
    }
    ...
    function show(...elements) {
        elements.flat().forEach(el => el?.classList?.remove("hide"));
    }
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        return {
            participants,
            scorePerParticipant: {
                [participants[0].id]: separatePenalties ? 666 : homeFinalScore,
                [participants[1].id]: separatePenalties ? 666 : awayFinalScore
            },
            statistics: {
                [participants[0].id]: {
                    corners: {
                    ...
                    goalsScoredExceptPenaltyPhase: {
                        value: separatePenalties ? homeFinalScore : 666,
                        isActive: true
                    },
                ...
                [participants[1].id]: {
                    ...
                    goalsScoredExceptPenaltyPhase: {
                        value: separatePenalties ? awayFinalScore : 666,
                        isActive: true
                    },
                    goalsScoredOnPenaltyPhase: {
                        value: isPenaltyShootout ? getRandomInt(3) : 0,
