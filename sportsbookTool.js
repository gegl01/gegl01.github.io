(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initSetEventPhaseSection() {
            categoryId = getCategoryIdByEventId(eventId);
            let eligibleCategoryIdsForScoreBoard = ["1", "2", "3", "4", "9", "11", "19", "34", "58", "72", "104", "119", "138"];
    ...
    function getHandballScoreBoard() {
        ...
        let scoreBoard = {
            ...
            currentPhase: {
                id: isFirstHalf ? 1 : 2,
                label: isFirstHalf ? "1st half" : "2nd half"
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
        ...
        getScoreBoardWithFinalScores(scoreBoard, participants, categoryId);
        return scoreBoard;
    }
