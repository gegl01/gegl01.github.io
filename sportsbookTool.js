(function () {
    ...
    function getTennisScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 11,
            category: "Tennis",
            currentPhase: { id: 2, label: getPhaseLabelWithEnLangCheck("2nd Set") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    // function s24(eventId) {
    //     let participants = obgState.sportsbook.event.events[eventId].participants;
    //     let stats = {
    //         table: [
    //             {
    //                 label: "Inter",
