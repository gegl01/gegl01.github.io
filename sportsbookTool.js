(function () {
    ...
    function getIframeURL() {
        ...
        for (var iframe of iframes) {
            if (iframe.src.includes("playground.net/stc-")) {
    ...
    function getCulture() {
        return obgClientEnvironmentConfig.startupContext.market.culture;
    }
