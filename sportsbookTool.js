(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.122";
    ...
    function initSbToolsMarket(scope) {
        ...
        function initPlayerPropsAddition() {
            const selectionId = getLastSelectionIdFromBetslip();
            ...
            window.addAnotherPlayerPropsMarket = () => {
                ...
                const lineValue = (getRandomInt(1000, 9999) + 0.5).toString();
                ...
                if (sampleMarketCopy.columnLayout == 2) createSelection(false, lineValue, isHomeTeam);
    ...
    function initSbToolsEvent(scope) {
        ...
        function logScoreBoardToConsole() {
            ...
            logEntityToConsole(scoreBoard, label);
        }
        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                const isVisualized = getElementById("chkVisualizedMainLine").checked;
                ...
                for (let playerName of playerNames) {
                    ...
                    if (isSingle) {
                        setMainLineMarkets();
                        createMarketForPlayer(playerName, getRandomInt(8) + 0.5, isHomeTeam, isMainLine);
                    } else {
                        let usedValues = new Set();
                        let min = getRandomInt(10) + 0.5;
                        let max = getRandomInt(10) + 1 + min;
                        ...
                        //         createMarketForPlayer(playerName, uniqueValue, isHomeTeam, isMainLine);
                        //     }
                        // }
                ...
                function createMarketForPlayer(playerName, lineValue, isHomeTeam, isMainLine) {
                    ...
                    createSelection(true, lineValue, isHomeTeam, isMainLine);
                    if (!oneSelectionsPerMarket) createSelection(false, lineValue, isHomeTeam, isMainLine);
                }

                function createSelection(isOver, lineValue, isHomeTeam, isMainLine) {
                    selectionId = `s-${marketId}-${isOver ? "Over" : "Under"}`;
                    selectionLabel = `${isMainLine && isVisualized ? "*" : ""}${isOver ? "Over" : "Under"} ${lineValue}`;
                    obgRt.createSelection(
                        eventId,
                        marketId,
                        selectionId,
