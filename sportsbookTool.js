(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initScoreBoardExtras(categoryId) {
            ...
            //             hide(iceHockeyScoreBoardExtrasSection, dartsScoreBoardExtrasSection, tennisScoreBoardExtrasSection);
            //             break;
            //         }
            //         case "2": {
            //             show(scoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection);
            //             hide(footballScoreBoardExtrasSection, dartsScoreBoardExtrasSection, tennisScoreBoardExtrasSection);
            //             break;
            //         }
            //         case "11": {
            //             show(scoreBoardExtrasSection, tennisScoreBoardExtrasSection);
            //             hide(footballScoreBoardExtrasSection, dartsScoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection);
            //             break;
            //         }
            //         case "34": {
            //             show(scoreBoardExtrasSection, dartsScoreBoardExtrasSection);
            //             hide(footballScoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection, tennisScoreBoardExtrasSection);
            //             break;
            //         }
            //         default: hide(scoreBoardExtrasSection);
            //     }
            // } else {
    ...
    function getTennisScoreBoard(participants, scoreBoardExtras) {
        ...
        if (scoreBoardExtras.isFiveSetMatch) {
            ...
            if (isSet3WonByHome) {
                ...
                set3HomeScore = (set3HomeScore === 6) ? getRandomInt(4) : 5;
            }
        } else {
