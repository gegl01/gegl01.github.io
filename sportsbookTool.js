(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function initSetEventPhaseSection() {
            categoryId = getCategoryIdByEventId(eventId);
            let categoryIdsForScoreBoard = ["1", "2", "3", "4", "8", "9", "11", "19", "34", "58", "60", "72", "104", "119", "138"];
            let categoryIdsForNoScoreBoard = ["7", "26", "43"];
            if (categoryIdsForScoreBoard.includes(categoryId)) {
                ...
                if (categoryIdsForNoScoreBoard.includes(categoryId)) {
                    scoreBoardNotSupportedMessage.innerText = "Scoreboard not supported by SB as of Apr, 2024";
                } else {
                    scoreBoardNotSupportedMessage.innerText = "Scoreboard support not yet added to this tool";
                }
            }
    ...
    function getFootballScoreBoard(participants) {
        ...
        return {
            ...
            currentPhase: {
                id: isFirstHalf ? 1 : 2,
                label: phaseLabelPostFix(isFirstHalf ? "1st half" : "2nd half")
            },
            currentVarState: 0,
    ...
    function getBaseballScoreBoard(participants) {
        ...
        let scoreBoard = {
            ...
            categoryId: 19,
            category: "Baseball",
            currentPhase: { id: 8, label: phaseLabelPostFix("8th Inning") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getIceHockeyScoreBoard(participants) {
        ...
        let scoreBoard = {
            ...
            categoryId: 2,
            category: "IceHockey",
            currentPhase: { id: 2, label: phaseLabelPostFix("2nd Period") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getTennisScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 11,
            category: "Tennis",
            currentPhase: { id: 2, label: phaseLabelPostFix("2nd Set") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBasketBallScoreBoard(participants) {
        let scoreBoard = {
            ...
            categoryId: 4,
            category: "Basketball",
            currentPhase: { id: 3, label: phaseLabelPostFix("3rd Quarter") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getVolleyBallScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 9,
            category: "Volleyball",
            currentPhase: { id: 2, label: phaseLabelPostFix("4th Set") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getEsportsScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 119,
            category: "ESport",
            currentPhase: { id: 2, label: phaseLabelPostFix("Map 4") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBadmintonScoreBoard() {
        ...
        return {
            ...
            categoryId: 72,
            category: "Badminton",
            currentPhase: { id: 2, label: phaseLabelPostFix("2nd Game") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getSquashScoreBoard() {
        ...
        return {
            ...
            categoryId: 104,
            category: "Squash",
            currentPhase: { id: 4, label: phaseLabelPostFix("4th Game") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBeachVolleyBallScoreBoard() {
        ...
        return {
            ...
            currentPhase: {
                id: 2,
                label: phaseLabelPostFix("2nd Set")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
    ...
    function getRugbyUnionScoreBoard(participants) {
        ...
        let scoreBoard = {
            ...
            currentPhase: {
                id: isFirstHalf ? 1 : 2,
                label: phaseLabelPostFix(isFirstHalf ? "1st Period" : "2nd Period")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
    ...
    function phaseLabelPostFix(phaseLabel) {
