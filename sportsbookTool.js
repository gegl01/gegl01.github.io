(function () {
    ...
    window.landingFromLHSM = () => {
        if (!IS_OBGSTATE_OR_XSBSTATE_EXPOSED){
            alert("Expose obgSate/xSbSate first");
            return;
        }
