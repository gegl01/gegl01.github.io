(function () {
    ...
    var participants = [];
    var previousEventId, previousMarketId, previousSelectionId, previousProfitBoosts;
    ...
    //     eventId = getLastEventIdFromBetslip() ?? eventId;
    ...
    window.initBonuses = () => {
        ...
        function populateBonusStakeSelector() {
            ...
            log("selectedBonusStake: " + !!selectedBonusStake);
