(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.116";
    ...
    function initSbToolsEvent(scope) {
        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                const newPlayerPropsView = getElementById("chkNewPlayerPropsView").checked;
                ...
                function createMarketForPlayer(playerName, lineValue, isHomeTeam) {
                    ...
                    if (newPlayerPropsView) market.marketTemplateTags.push(164);
