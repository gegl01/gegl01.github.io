    ...
    window.initBonuses = () => {
        ...
        function selectPb(value) {
            ...
            try {
                ...
                catRegCompLabelForPbDiv.innerHTML = "Couldn't fetch necessary data.<br>Please navigate to Price Boost lobby to fix this.<br>If it didn't help the related selection may not be open anymore while the API returned the boost for it regardless.";
