        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                function createMarketForPlayer(playerName, lineValue, isHomeTeam) {
                    ...
                    createSelection(true, lineValue, isHomeTeam);
                    if (!oneSelectionsPerMarket) createSelection(false, lineValue, isHomeTeam);
                }
