(function () {
    ...
    function getBrandName() {
        if (IS_OBGCLIENTENVIRONMENTCONFIG_EXPOSED) {
            return obgClientEnvironmentConfig.startupContext.brandName.toLowerCase();
        }
        if (IS_OBGSTARTUP_EXPOSED) {
            return obgStartup.config.appSettings.brandName.toLowerCase();
        }
        return "localhost";
    }
    ...
    function initSbToolsSelection(scope) {
        ...
        window.selectRadioForCreatePb = (value) => {
            if (value == "fixedOdds") {
    ...
    function getLastSelectionIdFromBetslip() {
        ...
        try {
            ...
            if (!!lastOrderedSelection.selection) {
                return lastOrderedSelection.selection.selectionId;
            } else {
                ...
                return selectionLegs[selectionLegs.length - 1].id;
            }
        } catch {
            return null;
        }
    ...
    function initSbToolsEvent(scope) {
        ...
        function initSetEventPhaseSection() {
            categoryId = getCategoryIdByEventId(eventId);
            let categoryIdsForScoreBoard = ["1", "2", "3", "4", "8", "9", "11", "17", "19", "34", "58", "60", "72", "104", "119", "138"];
            let categoryIdsForNoScoreBoard = ["7", "26", "43", "116"];
        ...
        function initScoreBoardExtras(categoryId) {
            ...
            if (chkLiveAddsScoreBoard.checked) {
                switch (categoryId) {
                    case "1": {
                        show(scoreBoardExtrasSection, footballScoreBoardExtrasSection);
                        hide(iceHockeyScoreBoardExtrasSection, dartsScoreBoardExtrasSection);
                        break;
                    }
                    case "2": {
                        show(scoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection);
                        hide(footballScoreBoardExtrasSection, dartsScoreBoardExtrasSection);
                        break;
                    }
                    case "34": {
                        show(scoreBoardExtrasSection, dartsScoreBoardExtrasSection);
                        hide(footballScoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection);
                        break;
                    }
                    // case "72":
                    // case "60":
                    ...
                    // case "138":
                    // case "19": {
                    //     show(scoreBoardExtrasSection, isServerScoreBoardExtrasSection);
                    //     hide(footballScoreBoardExtrasSection, iceHockeyScoreBoardExtrasSection);
                    //     break;
                    // }
                    default: hide(
                        scoreBoardExtrasSection,
        ...
        function initEventPropertyCheckboxes() {
            ...
            chkHasPrematchStatistics.checked = obgState.sportsbook.event.events[eventId].prematchStatisticsProviders.length !== 0;
            ...
            if (!eventPropertiesSection.classList.contains("hide")) {
                switch (getEventPhase(eventId)) {
                    case "Live":
                        ...
                        inactivate(hasPrematchStatisticsSection);
                        break;
                    case "Prematch":
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        return {
            ...
            currentPhase: {
                id: isFirstHalf ? 1 : 2,
                label: getPhaseLabelifNotEnglish(isFirstHalf ? "1st half" : "2nd half")
            },
            currentVarState: 0,
            isSecondLeg: scoreBoardExtras.isAggActive,
            matchClock: {
                seconds: getRandomInt(59),
                minutes: isFirstHalf ? getRandomInt(45) : getRandomInt(46, 90),
    ...
    function getBaseballScoreBoard(participants) {
        ...
        let scoreBoard = {
            ...
            categoryId: 19,
            category: "Baseball",
            currentPhase: { id: 8, label: getPhaseLabelifNotEnglish("8th Inning") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getIceHockeyScoreBoard(participants, scoreBoardExtras) {
        ...
        let scoreBoard = {
            ...
            categoryId: 2,
            category: "IceHockey",
            currentPhase: { id: 2, label: getPhaseLabelifNotEnglish("2nd Period") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getTennisScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 11,
            category: "Tennis",
            currentPhase: { id: 2, label: getPhaseLabelifNotEnglish("2nd Set") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBasketBallScoreBoard(participants) {
        let scoreBoard = {
            ...
            categoryId: 4,
            category: "Basketball",
            currentPhase: { id: 3, label: getPhaseLabelifNotEnglish("3rd Quarter") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: getRandomInt(59),
    ...
    function getDartsScoreBoard(participants, scoreBoardExtras) {
        let homeFinalScore = getRandomInt(5);
        let awayFinalScore = getRandomInt(5);
        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    oneEighties: { value: getRandomInt(homeFinalScore), isActive: scoreBoardExtras.is180sActive },
                ...
                [participants[1].id]: {
                    ...
                    isServer: { value: !isServer, isActive: true },
                    oneEighties: { value: getRandomInt(awayFinalScore), isActive: scoreBoardExtras.is180sActive },
                    matchFormat: { value: "0", isActive: true },
                    matchFormatSummary: { value: "0", isActive: true }
    ...
    function getVolleyBallScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 9,
            category: "Volleyball",
            currentPhase: { id: 2, label: getPhaseLabelifNotEnglish("4th Set") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getEsportsScoreBoard(participants) {
        ...
        return {
            ...
            categoryId: 119,
            category: "ESport",
            currentPhase: { id: 2, label: getPhaseLabelifNotEnglish("Map 4") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBadmintonScoreBoard() {
        ...
        return {
            ...
            categoryId: 72,
            category: "Badminton",
            currentPhase: { id: 2, label: getPhaseLabelifNotEnglish("2nd Game") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getSquashScoreBoard() {
        ...
        return {
            ...
            categoryId: 104,
            category: "Squash",
            currentPhase: { id: 4, label: getPhaseLabelifNotEnglish("4th Game") },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
                seconds: 0,
    ...
    function getBeachVolleyBallScoreBoard() {
        ...
        return {
            ...
            currentPhase: {
                id: 2,
                label: getPhaseLabelifNotEnglish("2nd Set")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
    ...
    function getRugbyUnionScoreBoard(participants) {
        ...
        let scoreBoard = {
            ...
            currentPhase: {
                id: isFirstHalf ? 1 : 2,
                label: getPhaseLabelifNotEnglish(isFirstHalf ? "1st Period" : "2nd Period")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
    ...
    function getSnookerScoreBoard() {
        let currentPhaseId = getRandomInt(1, 7)
        let homeMatchPoints = getRandomInt(140);
        let awayMatchPoints = getRandomInt(140);
        let homeFramePoints = getRandomInt(currentPhaseId - 1);
        let awayFramePoints = currentPhaseId - 1 - homeFramePoints;
        ...
        return {
            ...
            currentPhase: {
                id: currentPhaseId,
                label: getPhaseLabelifNotEnglish(getOrdinalSuffix(currentPhaseId) + " Frame")
            },
            currentVarState: 0,
            isSecondLeg: false,
            matchClock: {
            ...
            varState: 0,
            phaseCategoryId: currentPhaseId + "-17"
        }
    }
    ...
    function getPhaseLabelifNotEnglish(phaseLabel) {
