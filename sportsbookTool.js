(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        //providers
        const providersErrorMessage = getElementById("providersErrorMessage");
        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    expectedGoals: { value: scoreBoardExtras.isExpectedGoalsActive ? getRandomInt(1, 5) : 0, isActive: scoreBoardExtras.isExpectedGoalsActive },
