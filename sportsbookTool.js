(function () {
    ...
    function getFootballScoreBoard(participants, scoreBoardExtras) {
        ...
        return {
            participants,
            scorePerParticipant: {
                // [participants[0].id]: isSeparatePenaltiesEnabled ? getRandomInt(500, 599) : homeScore,
                // [participants[1].id]: isSeparatePenaltiesEnabled ? getRandomInt(500, 599) : awayScore
