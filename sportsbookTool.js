(function () {
    ...
    function initContext() {
        ...
        // startPolling(listenerForUserName);
        // startPolling(listenerForBrowserZoom);

        // intervalIdForPolling = setInterval(listenerForLoginState, POLLING_INTERVAL);
        // intervalIdsForPolling.push(intervalIdForPolling);

        // intervalIdForPolling = setInterval(listenerForUserName, POLLING_INTERVAL);
        // intervalIdsForPolling.push(intervalIdForPolling);

        // intervalIdForPolling = setInterval(listenerForBrowserZoom, POLLING_INTERVAL);
        // intervalIdsForPolling.push(intervalIdForPolling);
    ...
    function reloadPageWithFeature(feature) {
        ...
        switch (feature) {
            case "disableCache":
                params.push(new URLParam("forceNonCacheQueryString", getRandomGuid()));
        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    ballPossession: {
                        value: isBallPossessionHomeActive,
                ...
                [participants[1].id]: {
                    ...
                    ballPossession: {
                        value: isBallPossessionAwayActive,
                        isActive: !isBallPossessionInactive
                    },
                    halfTimeScore: {
