(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.110";
        ...
        return {
            ...
            statistics: {
                [participants[0].id]: {
                    ...
                    penaltyOutcome: {
                        value: "Scored/Shooting/NotTaken/NotTaken/NotTaken",
                        isActive: true
                    },
                    possession: {
