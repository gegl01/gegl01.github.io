(function () {
    ...
    function getDeviceExperience() {
        ...
        if (IS_SBMFESSTARTUPCONTEXT_EXPOSED) { return sbMfeStartupContext?.device?.deviceExperience; }
        return null;
    }
        ...
        function listenerForEventIfEventLocked() {
            ...
            switch (getEventPhase(eventId)) {
                ...
                case "Prematch":
                    ...
                    inactivate(hasLiveStatisticsSection, hasLiveVisualSection);
