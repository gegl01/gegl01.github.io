(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.124";
    ...
    window.copyToClipboard = (param) => {
        ...
        switch (param) {
            ...
            case "userName":
                text = userName;
                break;
            case "iframeUrlFromMfe":
                text = getIframeUrlFromMfe();
                break;
        }
    ...
    function getIframeUrlFromMfe(){
        ...
        const params = SB_ENVIRONMENT == "test" ? "sealStore=false" : "exposeObgState=true&exposeObgRt=true";
        return `${baseUri}/${staticContextId}/${userContextId}/?${params}`;
    }
    ...
    function initSbToolsEvent(scope) {
        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                const playerPropsMarketName = `Player Props${isNewPlayerPropsView ? " (NEW) " : ""} by SB Tool - ${oneSelectionsPerMarket ? "1 selection" : "2 selections"} per Market`;
