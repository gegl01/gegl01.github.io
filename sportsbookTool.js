(function () {
    ...
    window.landingFromLHSM = () => {
        ...
        // alert(
        //     "You should land on these pages upon clicking on the category links from LHSM > A-Z:\n\n"
        //     + "CATEGORY PAGE (due to 2+ regions):\n"
        //     + getArrayAsAlphaBeticalCommaSeparatedString(landOnCatPage)
        //     + "\n\nREGION PAGE (due to 1 region having 2+ competitions):\n"
        //     + getArrayAsAlphaBeticalCommaSeparatedString(landOnRegPage)
        //     + "\n\nCOMPETITION PAGE (due to 1 region having 1 competition):\n"
        //     + getArrayAsAlphaBeticalCommaSeparatedString(landOnComPage)
        // )
    }
