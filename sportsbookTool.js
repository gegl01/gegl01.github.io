    ...
    window.initBonuses = () => {
        ...
        function populateAccaInsSelector() {
            ...
            for (let ins of accaInsurances) {
                ...
                //     option.innerHTML += " " + "&#129351;";
                // }
                if (getIsSelectedAccaInsApplied(ins.id)) {
                    option.innerHTML += " " + "&#129351;";
                }
