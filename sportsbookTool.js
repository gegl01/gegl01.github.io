(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.127";
    ...
    function initSbToolsEvent(scope) {
        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                const templateMap = {
                    playerShots: "PLYPROPTESTPLAYERSHOTS",
                    playerShotsOnTarget: "PLYPROPTESTSHOTSONTARGET",
                    playerFouls: "PLYPROPTESTFOULS",
                    playerPasses: "PLYPROPTESTPASSES",
                    playerAssists: "PLYPROPTESTASSISTS",
                    playerNeither: "PLYPROPTEST",
                };
                const marketTemplateId = templateMap[statisticsKey];
                const playerPropsMarketName = `Player Props${isNewPlayerPropsView ? " (NEW) " : ""} by SB Tool - ${camelCaseToPhrase(statisticsKey.replace("player", ""))}`;
