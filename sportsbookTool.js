    ...
    window.initBonuses = () => {
        ...
        function populatePbSelectorBy(entityName) {
            ...
            for (var pb of sortedPbArray) {
                option = document.createElement("option");
                if (entityName == "pbName" || entityName == "garbage") {
                    option.text = pb.name;
        ...
        // var arrayOfApplicablePriceboosts = [];    
