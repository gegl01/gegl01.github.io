    ...
    function initSbToolsEvent(scope) {
        ...
        window.createMarket = () => {
            ...
            function getMarketTabsOnEventPanel() {
                let pinningTab = document.querySelector("[test-id='event.market.tab.4']"); // qa
                if (pinningTab == null) {
                    pinningTab = document.querySelector("[test-id='event.market.tab.pinning']"); // prod
                }
                if (pinningTab == null) {
                    pinningTab = document.querySelector("[test-id='pinning']"); // gen1
                }
                return pinningTab.parentElement.getElementsByClassName("obg-tab-label");
            }
