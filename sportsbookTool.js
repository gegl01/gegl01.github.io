(function () {
    ...
    function initSbToolsEvent(scope) {
        ...
        function getTradedAs() {
            ...
            else return "Undefined (related tag missing)";
        }

        function getIsEsport() {
            return getIsTagPresent("sb-mt-esports") ? "True" : "False";
        }
        ...
        //     let categoryIdsForFastMarket = ["1", "4", "10", "11", "104", "138", "2"];
        //     if (getEventPhase(eventId) != "Live") {
        //         marketTemplateTagsArrayForFastMarket = undefined;
        //         displayInRed(fastMarketMessage);
        //         fastMarketMessage.innerText = "For Live events only"
        //         inactivate(btCreateFastMarket);
        //     } else if (categoryIdsForFastMarket.includes(categoryId)) {
        ...
        function initCreateFastMarketSection(categoryId) {
            ...
            marketTemplateTagsArrayForFastMarket = undefined;
            displayInRed(fastMarketMessage);
            fastMarketMessage.innerText = message;
            inactivate(btCreateFastMarket);
        }
