(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.125";
    ...
    function initSbToolsEvent(scope) {
        ...
        function listenerForEventIfEventLocked() {
            ...
            switch (getEventPhase(eventId)) {
                case "Live":
                    if (getEventHasValidScoreBoard(eventId)) {
