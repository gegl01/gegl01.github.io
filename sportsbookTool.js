(function () {
    ...
    function getIsSportsbookSealed() {
    ...
    function initSbToolsEvent(scope) {
        ...
        function getTradedAs() {
            ...
            if (getIsTagPresent("sb-traded-prematch")) return "Prematch";
            if (getIsTagPresent("sb-traded-live")) return "Live";
    ...
    function initWalletFunctions() {
        ...
        Object.entries(wallet.wallets).forEach(([currencyCode, data]) => {
            ...
            button.className = "btSimple btWalletSet";
