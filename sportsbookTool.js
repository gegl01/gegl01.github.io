(function () {
    ...
    window.initBonuses = () => {
        ...
        var pbStakeRangeDiv = document.getElementById("pbStakeRangeDiv");
        ...
        var freeBetNoOfSelectionsDiv = document.getElementById("freeBetNoOfSelectionsDiv");
        ...
        function selectPb(value) {
            ...
            try {
                ...
                pbPathToCompetition.innerHTML = "Couldn't fetch necessary data.<br>Please navigate to Price Boost lobby to fix this.<br>If it didn't help, the related selection may not be open anymore but the API still returned the boost.";
