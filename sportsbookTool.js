(function () {
    ...
    const SB_TOOL_VERSION = "v1.6.117";
    ...
    function initSbToolsEvent(scope) {
        ...
        window.createMarket = () => {
            ...
            function createPlayerPropsMarket() {
                ...
                const marketTemplateTags = isNewPlayerPropsView ? [...MARKET_TEMPLATE_TAGS_FOR_PLAYER_PROPS, 164] : [...MARKET_TEMPLATE_TAGS_FOR_PLAYER_PROPS];
